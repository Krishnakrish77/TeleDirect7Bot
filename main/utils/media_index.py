...
def _to_serializable(item: HubItem) -> dict:
    return {
        ...
        "intro_source": getattr(item, "intro_source", "") or "",
        ...
        "source_audio_codec": getattr(item, "source_audio_codec", "") or "",
...
def _from_serializable(d: dict) -> HubItem:
    return HubItem(
        ...
        intro_source=d.get("intro_source", "") or "",
        ...
        source_audio_codec=d.get("source_audio_codec", "") or "",
