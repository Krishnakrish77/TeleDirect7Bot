...
type BookDensity = 'comfortable' | 'compact';
...
function localBookDensity(): BookDensity { try { return localStorage.getItem(BOOK_DENSITY_KEY) === 'compact' ? 'compact' : 'comfortable'; } catch (_) { return 'comfortable'; } }
function writeBookDensity(value: BookDensity) { try { localStorage.setItem(BOOK_DENSITY_KEY, value); } catch (_) {} }
...
export function BooksPage({ user }: { user: User | null }) {
  ...
  return <main className="hub-main books-page">
    ...
    <div className="books-library-controls">
      ...
      <div className="books-density-control" role="group" aria-label="Book card density">
        <button type="button" className={bookDensity === 'comfortable' ? 'is-active' : ''} aria-pressed={bookDensity === 'comfortable'} onClick={() => updateBookDensity('comfortable')}>Comfortable</button>
