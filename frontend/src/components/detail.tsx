...
import { BookmarkIcon, CheckIcon, ChevronRightIcon, DownloadIcon, ListIcon, ListPlusIcon, MaximizeIcon, PauseIcon, PlayIcon, ShuffleIcon, XIcon } from '../icons';
  ...
  const requestFullscreen = useCallback(() => {
    ...
    try {
      ...
      if (result && typeof result.catch === 'function') {
        result.catch(() => setFullscreenSupported(false));
      }
    } catch {
      setFullscreenSupported(false);
    }
