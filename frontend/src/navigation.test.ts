...
describe('React app navigation', () => {
  it('parses app watchlist, playlist, and stats routes', () => {
  ...
  it('maps classic watchlist, playlist, and stats links into the app shell', () => {
  ...
  it('maps app watchlist, playlist, and stats routes back to classic URLs', () => {
