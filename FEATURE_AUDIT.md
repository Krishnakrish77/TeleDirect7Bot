...
_Evidence: Webwright runs `outputs/perf_audit_live/final_runs/run_3`, `run_4`, and `run_5`, local Vite/Playwright smoke checks, and production Vite build output._
